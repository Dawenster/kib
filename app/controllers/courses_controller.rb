class CoursesController < ApplicationController
  def index
    ...
    if current_user.present?
      @requested_courses_as_student = current_user.requested_and_incomplete_courses_as_student # Cannot retake
      @requested_courses_as_teacher = current_user.requested_and_incomplete_courses_as_teacher # Cannot retake
